*Privacy Policy*
Your privacy is important to FreesoulApps. Sometimes we need information to provide services that you request, this privacy statement applies to FreesoulApps and its products, namely Rotter News, Light On.
...
We may collect information about the services that you use and how you use them, such as when you view and interact with our content. We may collect device-specific information (such as your hardware model, operating system version, unique device identifiers, and mobile network information). Thracian Software will not share that information with third parties. 


Camera 

Certain apps may use camera. Any data from camera and other sensors is neither collected nor distributed by FreesoulApps. All this personal data is saved only to user's device with user consent and action.
